                    ...
                    <div id="staffList" class="card-body collapse show">
                        ...
                        <div class="tab-content">
                            <div id="addProduct" class="tab-pane active">
                                <form class="form-main" action="{{route('staff.group.update.ids')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <form class="form-main" action="{{route('staff.group.update.ids')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="row border-bottom pt-1 pb-1">
                                                <div class="col-6">
                                                    <div class="custom-control custom-checkbox mr-3">
                                                        <input type="checkbox" class="custom-control-input" id="staff_{{$staff->id}}" name="staff[{{$i}}][id]" 
                                                            value="{{$staff->id}}" 
