    ...
    */
    ...
    function checkSaleProduct(id, title, price) {
        let html = '<tr id="sale_product_'+id+'">';
            ...
            html += '<td class="tb-6"><div class="sale-hide-sp">{{__('sale.list.amount')}}</div><input type="text" id="amount_'+id+'" class="form-control" name="sale_product['+i+'][amount]" value="'+price+'" readonly /></td>';
