        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-justified mb-2" role="tablist">
                    <li class="nav-item">
                    <a class="nav-link bg-info text-white {{$request->customers_page || $request->quotaion_no ? ' active' : ''}}" data-toggle="tab" href="#pay">ការសងប្រាក់នៃការលក់ទាំងអស់</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade {{$request->customers_page || $request->quotaion_no ? ' active show' : ''}}" id="pay">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach( $customers as $customer)
                                        ...
                                        @if ($customer->sales->count() > 0)
                                        <tr>
                                            <td colspan="1" id="customer_{{$customer->id}}" class="collapse p-0 {{ $request->quotaion_no ? ' show' : ''}}">
