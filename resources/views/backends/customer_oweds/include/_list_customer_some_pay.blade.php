<div id="tab-list" class="row mb-2">
    <div class="col-12">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form id="sale-search" action="{{ route('customer_owed.some_pay') }}" method="GET" class="form form-horizontal form-search form-inline mb-2 d-inline-flex">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="pay_in_ready">
                        <div class="table-responsive cus-table">
                            <table class="table table-bordered">
                                <thead class="bg-danger text-light">
                                    <tr>
                                        <th class="pr-4">
                                            {!! \App\Helper\SortableHelper::order(__('sale.list.invoice_code'), 'quotaion_no', 'customer_owed.some_pay') !!}
                                        </th>
                        ...
                        <div class="d-flex justify-content-center">
                            {{ $saleSomePays->appends(request()->query())->links() }}
                        </div>
